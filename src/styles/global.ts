...
export const GlobalStyle = createGlobalStyle`
     ...
     * {
     ...
     body {
          ...
          url('src/assets/images/pattern-circle.svg') no-repeat fixed left -2.5rem top -4rem / 12.5rem padding-box border-box,
          url('src/assets/images/pattern-circle.svg')  no-repeat fixed right -50% bottom 0 / 50% padding-box border-box,
